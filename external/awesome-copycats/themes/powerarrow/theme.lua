...
theme.widget_no_vol                 			= theme.dir .. "/icons/spkr_no.png"
...
-- volpulse = lain.widgets.pulseaudio(
--    {
--       cmd = "pacmd list-sinks | sed -n -e '/index/p' -e '0,/*/d' -e '/base volume/d' -e '/volume:/p' -e '/muted:/p' -e '/device\.string/p'",
--       settings = function()
...
--       end,
--       -- scallback = function()
--       --    return "pacmd list-sinks | sed -n -e '/index/p' -e '0,/*/d' -e '/base volume/d' -e '/volume:/p' -e '/muted:/p' -e '/device\.string/p'"
--       -- end
--    })

-- if volume_now.index ~= nil then
--    volpulse.index = volume_now.index
-- end
